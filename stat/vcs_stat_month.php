...
<script language="javascript">
	$("document").ready(function() {
		loadStatisticsVcsStatusMonthlyChart();
	});
...
<div id="statistics_check">
	<div class="outline">
		<div class="container">
			...
			<div id="tit_area">
				<div class="tit_line">
					 <h1><span id='page_title'><? echo trsLang('점검현황','checkstatustext');?> <small><? echo trsLang('월별','monthlytext');?></small></span></h1>
				</div>
				...
				<?
					...
					$title[] = $searchkey;
					$title[]= trsLang('월별점검현황','monthlyvcsstatustext');
				...
				<div class="section01" style='height:600px;'>
					<div style="height:450px;"><canvas id="chartVcsMonth" name='chartVcsMonth' /></canvas></div>
					
					<div id='chartVcsMonth_DataTable' >
						<!--chart data table-->
					</div>
					...
					<div class="btn_wrap right" style='margin-top:50px;'>
						<? 
							$excel_down_url = $_www_server . "/stat/vcs_stat_month_excel.php?enc=" . ParamEnCoding($param); 
			...
			<div class='ch_legend' style='width:50%;'><div id="chartPcCheckWEAK_legend" class="chart-legend" style='width:100%;'></div></div>
		...
		<div class="section03" style='width:46%;margin-left:20px'>
			<h1> > <?=$_LANG_TEXT['virusdectionstatustext'][$lang_code]?></h1>
					<div class="ch"><canvas id="chartPcCheckVIRUS" name="chartVcsDay" width="260px" height="260px"/></canvas></div>
			<div class='ch_legend' style='width:50%;'><div id="chartPcCheckVIRUS_legend" class="chart-legend" style='width:100%; '></div></div>
