...
<script language="javascript">
	$("document").ready(function() {
		loadStatisticsVisitStatusDailyChart();
	});
...
<div id="statistics_check">
	<div class="outline">
		<div class="container">
			...
			<div id="tit_area">
				<div class="tit_line">
					 <h1><span id='page_title'><?=$_LANG_TEXT["inoutstatus"][$lang_code];?> <small><? echo trsLang('일별','dailytext');?></small></span></h1>
				</div>
				...
				<?
					...
					$title[] = $searchkey;
					$title[]= $_LANG_TEXT['dailyinoutstatus'][$lang_code];
				...
				<div class="section01" style='height:600px;'>
					...
					<div id='chartVisitDay_DataTable' >
						<!--chart data table-->
					</div>
					...
					<div class="btn_wrap right" style='margin-top:50px;'>
						<? 
							$excel_down_url = $_www_server . "/stat/visit_stat_excel.php?enc=" . ParamEnCoding($param); 
