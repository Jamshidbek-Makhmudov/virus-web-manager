...
<script language="javascript">
	$("document").ready(function() {
		loadStatisticsRentalStatusMonthlyChart();
	});
...
<div id="statistics_check">
	<div class="outline">
		<div class="container">
			...
			<div id="tit_area">
				<div class="tit_line">
					 <h1><span id='page_title'><? echo trsLang('물품대여현황','item_rental_status'); ?> <small><? echo trsLang('월별','monthlytext');?></small></span></h1>
				</div>
				...
				<?
					...
					$title[] = $searchkey;
					$title[]= trsLang('월별물품대여현황','monthlyrentalstatus');
				...
				<!--chart-->
				<div class="section01">
					<div style="height:450px;"><canvas id="chartRentalMonth" name='chartVisitMonth' /></canvas></div>
					
					<div id='chartRentalMonth_DataTable' >
						<!--chart data table-->
					</div>
					...
					<div class="btn_wrap right" style='margin-top:50px;'>
						<? 
							$excel_down_url = $_www_server . "/stat/rental_stat_month_excel.php?enc=" . ParamEnCoding($param); 
