...
$("document").ready(function(){
	...
	StatisticsUserWVCheckData('<?=$v_user_seq?>');
	...
	<div class="content">
		<div class='tit'>
			...
			<?if($src=="pop_user_vcs_summary"){?>
				<a href="javascript:" onclick="return popUserVcsSummary('<?=$v_user_seq?>');"><div class="prev_page"><?=$_LANG_TEXT['btngobeforepage'][$lang_code]?></div></a>
			<?}?>
...
<?
					...
					if($row_count == 0){
						...
						echo "<tr><td colspan='8'>".$_LANG_TEXT['nodata'][$lang_code]."</td></tr>";
					}
}
?>
					</table>
...
<? 
	$param = "v_user_seq=".$v_user_seq."&src=".$src;
