...
if($_SESSION['user_seq'] != "0"){	//dptadmin
...
if($result){
	...
	if($row_count > 0){
		...
		if($_db_encription_kind=="") $_db_encription_kind = "3";	//AES_Rijndael_Encript
		...
		<div class="container">
			...
			<form name='frmPolicy' id='frmPolicy' method='post'>
				...
				<table class="view" style='margin-top:0px'>
					...
					<tr>
						<th><? echo trsLang('방문자퇴실처리배치실행','visitorcheckoutbatchyn');?></th>
						<td>
						...
						<th class='line'><?=$_LANG_TEXT['screenlockguidetext'][$lang_code]?></th>
						<td>
					...
					<tr>
						<th><?=$_LANG_TEXT['datakeepdaytext'][$lang_code]?></th>
						<td>
					...
					<tr class="bg">
						<th><?=$_LANG_TEXT['adminpasswordchagetermtext'][$lang_code]?></th>
						<td colspan="3">
					...
					<tr class="bg">
						...
						<td class='line' style='width:30%;'>
							<select  name='db_encription_kind' id='db_encription_kind'>
								...
								<option value='2' <? if($_db_encription_kind=="2" ) echo "selected" ; ?>>AES 256 CBC(2)</option>
								<option value='3' <? if($_db_encription_kind=="3" ) echo "selected" ; ?>>AES 192 CBC(3)</option>
							</select>
						</td>
				...
				<div >
					<table class="view" style='margin-top:30px;'>
						...
						<tr class="bg">
							...
							<td style='min-width:200px;width:200px'>
								<input type='' value='<? echo $_web_type;?>' class="frm_input" style="width:40px" disabled>
							</td>
							...
							<td>
								...
								<input type='' value='<? echo $_web_port;?>' class="frm_input" style="width:30px" disabled>
							</td>
						</tr>
						<tr>
