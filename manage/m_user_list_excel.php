...
$userinfotext = $_LANG_TEXT["userinfotext"][$lang_code];
...
$workyntext = $_LANG_TEXT["workyntext"][$lang_code];
$userleveltext = $_LANG_TEXT["userleveltext"][$lang_code];
$uselangtext = $_LANG_TEXT["uselangtext"][$lang_code];
$registerdatetext = $_LANG_TEXT["registerdatetext"][$lang_code];
$workyestext = $_LANG_TEXT["workyestext"][$lang_code];
$worknotext = $_LANG_TEXT["worknotext"][$lang_code];
...
?>
	...
	<Worksheet ss:Name="<?php echo $userinfotext; ?>">
		<Table>
			<Column ss:Width='60' />
			<Column ss:Width='100' />
			<Column ss:Width='100' />
			...
			<Row>
				...
				<Cell ss:StyleID="s20"><Data ss:Type="String"><?php echo $userleveltext; ?></Data></Cell>
