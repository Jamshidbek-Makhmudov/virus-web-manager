...
/*
Description : 데이터 보관기간 경과된 방문자 데이터 삭제  
*/
...
include "./common.php";
		...
		/*
		 ALTER PROCEDURE [dbo].[up_UserDataDay](@vUSER_DATA_DELETE_DAY int)
		 */
		
		$vUSER_DATA_DELETE_DAY =  AES_Rijndael_Decript( base64_decode($_REQUEST['vUSER_DATA_DELETE_DAY']) , $_AES_KEY, $_AES_IV);
		...
		$sql_user = " EXEC dbo.up_UserDataDay  $vUSER_DATA_DELETE_DAY ";
