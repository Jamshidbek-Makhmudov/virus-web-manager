...
border:1px solid black;">
     <tr>
                ...
                <th style="width:100px;background-color: #D4D0C8; border:0.5px solid black;">'.$carry_in_status.'</th>
                ...
                <th style="width:500px;background-color: #D4D0C8; border:0.5px solid black;">sha256</th>
	...
	if($file_send_status==1 && $file_send_date != ""){
		...
		$splitHTML[$i] .= '<tr>
                ...
                <td   style="text-align: center; vertical-align: middle;min-height:30px;  border:0.5px solid black;  ">' . formatBytes($file_size ). '</td>
...
print json_encode($splitHTML,JSON_UNESCAPED_UNICODE);
